...
import IncrementModel from "./IncrementModel"; // ✅ make sure filename matches
    ...
    <div className="bg-gray-800 rounded-lg shadow-lg text-white w-full max-w-2xl mx-auto">
      ...
      {open && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-gray-900 rounded-lg shadow-lg w-[90%] md:w-[80%] lg:w-[70%] p-6 relative">
            {/* Close button */}
            <button
